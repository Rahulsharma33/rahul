...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title> Meeting Management Websites Using LAMP</title>
        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
						<li class="logo-wrapper"><a href="index.php"><img src="img/logo.jpg" width="120pix" height="140pix" alt="Meeting Management Websites"></li>
						<li class="active">
							<a href="index.php">Home</a>
						</li>
						<li>
							<a href="features.html">Events</a>
						</li>
							...
							<div class="mainmenu-submenu">
								<div class="mainmenu-submenu-inner"> 
									<div>
										<h4>Homepage</h4>
										<ul>
											<li><a href="index.php">Homepage (Sample 1)</a></li>
						...
						<li>
							<a href="credits.html">Callenders</a>
						</li>
						<li>
							<a href="credits.html">Contacs</a>
						</li>
						<li>
							<a href="credits.html">Proposals</a>
						</li>
						<li>
							<a href="credits.html">Invoices</a>
						</li>
						<li>
							<a href="credits.html">Contracts</a>
						</li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="calltoaction-wrapper">
							<h3>It's a Meeting Management Websites using LAMP</h3> <a href="http://www.dragdropsite.com" class="btn btn-orange">Click here!</a>
						</div>
					</div>
				</div>
			</div>
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			...
		    			<p class="contact-us-details">
	        				<b>Address:</b> Lovely Professional University<br/> 
	        				<b>Phone:</b> 9781588567<br/>
	        				<b>Fax:</b> Comming Soon<br/>
	        				<b>Email:</b> <a href="mailto:rahulsharma.sharma562@gmail.com">Mail to us for supporting</a>
	        			</p>
		    		</div>
